...
class MultipleSqlGenerator:
    ...
    @staticmethod
    def schema_paths_to_strings(schemas: List[Dict[str, Any]]) -> List[str]:
        """One prompt string per retrieved schema path (same shape as predict(question, schema))."""
        out: List[str] = []
